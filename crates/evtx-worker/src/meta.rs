...
const SOURCE_BASE: &str = "https://github.com/Query-farm/vgi-evtx/blob/main/crates/evtx-worker/src";

/// Build the implementation `vgi.source_url` for a file under `evtx-worker/src`,
/// e.g. `source_url("scalar/inspect.rs")`.
...
///
/// `relative_path` is the implementing file relative to `evtx-worker/src`.
pub fn object_tags(
    title: &str,
    description_llm: &str,
    description_md: &str,
